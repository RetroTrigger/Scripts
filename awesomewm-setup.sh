...
#Arch-Based
yay -S git awesome rofi picom gnome-polkit lxappearance flameshot pnmixer network-manager-applet xfce4-power-manager kitty micro feh imagemagick bluez blueman xbacklight pcmanfm firefox xsecurelock -y
